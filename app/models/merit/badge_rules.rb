...
module Merit
  class BadgeRules
    ...
    def initialize
      ...
      grant_on 'pages#update', :badge => 'wordsmith', :level => 1 do |page|
        page.story.user.stories.collect { |s| s.get_word_count }.sum >= 1000
      end
      grant_on 'pages#update', :badge => 'wordsmith', :level => 2 do |page|
        page.story.user.stories.collect { |s| s.get_word_count }.sum >= 3000
      end
      grant_on 'pages#update', :badge => 'wordsmith', :level => 3 do |page|
