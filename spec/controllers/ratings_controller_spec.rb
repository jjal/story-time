...
describe RatingsController do
  ...
  describe "GET show" do
    ...
    it "assigns the requested rating as @rating" do
      story = Story.create!
      rating = story.ratings.create! valid_attributes
      get :show, {:id => rating.to_param, :story_id => story.to_param}, valid_session
  ...
  describe "GET new" do
    it "assigns a new rating as @rating" do
      story = Story.create!
      get :new, {:story_id => story.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested rating as @rating" do
      story = Story.create!
      rating = story.ratings.create! valid_attributes
      get :edit, {:id => rating.to_param, :story_id=> story.to_param}, valid_session
      assigns(:rating).should eq(rating)
    end
  end
